...
const STRINGS = {
  ...
  en: {
    ...
    iconUpload: "Upload a different photo",
    ...
    iconCoverFailed: "Couldn't read the cover photo directly. Use “Upload a different photo” instead (always works).",
    lifeBtn: "Life photos",
