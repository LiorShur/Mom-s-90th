...
const STRINGS = {
  he: {
    ...
    photoLabel: "תמונה או שתיים (לא חובה)",
    photosSelected: (n) => (n === 1 ? "תמונה אחת נבחרה" : `${n} תמונות נבחרו`),
    choosePhotos: "בחירת תמונות",
    addPhoto: "הוספת תמונה",
    photoAdjustHint: "גררו למיקום · החליקו כדי לקרב או להרחיק. הרחקה עד הסוף מחזירה את כל התמונה.",
    zoomLabel: "מרחק תצוגה",
  ...
  en: {
    ...
    photoLabel: "A photo or two (optional)",
    photosSelected: (n) => `${n} photo${n > 1 ? "s" : ""} selected`,
    choosePhotos: "Choose photos",
    addPhoto: "Add another",
    photoAdjustHint:
      "Drag to reposition · slide to zoom. Zoom all the way out to bring back the whole photo.",
    zoomLabel: "Zoom",
