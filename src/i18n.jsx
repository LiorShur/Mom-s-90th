...
const STRINGS = {
  he: {
    ...
    collageHint: "גררו את התמונות כדי לסדר אותן — הן יכולות לחפוף. לחצו על תמונה כדי לכוונן גודל, סיבוב, צל ועוד.",
    ...
    exportImagesBtn: "הורדת תמונות עמודים (איכות גבוהה)",
  ...
  en: {
    ...
    collageHint: "Drag the photos to arrange them — they can overlap. Click a photo to adjust its size, rotation, shadow and more.",
    ...
    exportImagesBtn: "Download page images (hi-res)",
