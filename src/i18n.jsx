...
const STRINGS = {
  he: {
    ...
    lifeBtn: "תמונות חיים",
    lifeHint: "העלו את תמונות החיים של מרים, והוסיפו שנה וכיתוב לכל אחת — האלבום יסתדר אוטומטית לפי שנה, וכל תמונה מוצגת במלואה.",
    lifeAddPhotos: "הוספת תמונות (אפשר לבחור כמה ביחד)",
    lifeYear: "שנה",
    lifeCaption: "כיתוב (לא חובה)",
    savedOk: "נשמר ✓",
    noVoice: "אין קול",
    downloadQR: "הורדת QR",
  ...
  en: {
    ...
    lifeBtn: "Life photos",
    lifeHint: "Upload Miriam's life photos and add a year + caption to each — the album sorts by year automatically, and every photo is shown in full.",
    lifeAddPhotos: "Add photos (select many at once)",
    lifeYear: "Year",
    lifeCaption: "Caption (optional)",
    savedOk: "Saved ✓",
    noVoice: "no voice",
